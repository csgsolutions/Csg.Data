...
public interface IDatabase
{
    ...
    /// <summary>
    ///     When implemented in a derived class, gets an instance of the <see cref="System.Data.Common.DbProviderFactory" />
    ///     for the provider associated with the database.
    /// </summary>
    ...
    /// <summary>
    ///     When implemented in a derived class, opens a database connection and begins a transaction with the given isolation
    ///     level.
    /// </summary>
    /// <returns></returns>
    IDbScope BeginTransaction(IsolationLevel isoLevel);
}