...
/// <summary>
///     When implemented in a derived class, provides a query builder on an active connection and/or transaction for which
///     to build and execute a SELECT statement.
/// </summary>
public interface IDbQueryBuilder
{
    /// <summary>
    ///     When implemented in a derived class, returns the root table of the query. This is the table listed immmediately
