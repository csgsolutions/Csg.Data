...
public static class Extensions
{
    ...
    /// <returns></returns>
    public static SqlCompareFilter Add(this ICollection<ISqlFilter> collection, ISqlTable table, string columnName,
        SqlOperator oper, DbType dataType, object value)
    {
    ...
    /// <summary>
    ///     Adds <see cref="SqlOrderColumn" /> columns to the given order collection by parsing each value in the given sort
    ///     expression
    /// </summary>
    /// <param name="collection"></param>
    ...
    public static void Add(this ICollection<SqlOrderColumn> collection, string sortExpression)
    {
        ...
        foreach (var part in parts) collection.Add(SqlOrderColumn.Parse(part));
    }
    ...
    {
        foreach (var columnExpr in columnExpressions) yield return SqlColumn.Parse(table, columnExpr);
    }
}