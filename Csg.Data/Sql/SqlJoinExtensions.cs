...
public static class SqlJoinExtensions
{
    ...
    public static void AddInner(this ICollection<ISqlJoin> collection, ISqlTable leftTable, ISqlTable rightTable,
        params ISqlFilter[] conditions)
    {
    ...
    public static void AddLeft(this ICollection<ISqlJoin> collection, ISqlTable leftTable, ISqlTable rightTable,
        params ISqlFilter[] conditions)
    {
    ...
    public static void Add(this ICollection<ISqlJoin> collection, ISqlTable leftTable, SqlJoinType joinType,
        ISqlTable rightTable, IEnumerable<ISqlFilter> conditions)
    {
        collection.Add(new SqlJoin(leftTable, joinType, rightTable, conditions));
    }

    public static void Add(this ICollection<ISqlJoin> collection, ISqlTable leftTable, SqlJoinType joinType,
        ISqlTable rightTable, string key)
    {
