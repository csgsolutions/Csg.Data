...
namespace Csg.Data
{
    ...
    public class MockParameterCollection : List<IDbDataParameter>, IDataParameterCollection
    {
        public object this[string parameterName]
        {
            get
            {
                return this.SingleOrDefault(x => x.ParameterName == parameterName);
            }
            set
            {
        ...
        {
            return this.IndexOf(this.SingleOrDefault(x => x.ParameterName == parameterName));
        }
    ...
    public class MockCommand : System.Data.IDbCommand
    {
        public MockCommand()
        {
            this.Parameters = new MockParameterCollection();
        }
